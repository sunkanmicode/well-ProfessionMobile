  ...
  return (
    <View className="py-10 px-6 my-5">
      <View className="flex-row justify-between">
        ...
        <Text className="text-lg text-[#090A0A]">Password reset</Text>
        <View />
      </View>
      <View className="w-80 h-44 my-10 mx-5">
        ...
        <View className="m-auto">
          <Text className="text-xl font-bold m-auto">
            Forgot your password?
          </Text>
          <Text className="text-[#6C7072] text-center">
      ...
      <View>
        <CustomInput label="Email address" placeholder="input your email" />
        <CustomButton primary title="Continue" onPress={()=>{
